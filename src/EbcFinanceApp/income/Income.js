    ...
    <main className="income-main">
      ...
      <section className="income-main-month-title-cx">
        ...
        <div className="income-main-title">
          <h3>Total Income:</h3>
          <h3 style={{display:'flex', alignItems:'center'}}><svg
                    fill="#ffffff"
                    version="1.1"
                    style={{ fill: "black" }}
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="income-main-content">
        {incomes.map((income, i) => (
          <div
            ...
            className="income-cx"
            style={{borderBottom:`${income?.color} solid`, }}
          >
            <span
              className="income-main-icon"
              style={{ backgroundColor: `${income?.color}`, height: "100%" }}
            ></span>
